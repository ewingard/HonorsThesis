...
# to test in terminal, copy the commented bit below and paste into terminal: 
# python predict.py --csv "CSVFILENAME_imgs.csv"
...
if __name__ == "__main__":
    ...
    predidct_age_gender_race("jenntest_outputs.csv", SAVE_DETECTED_AT)
#To ONLY read from detected faces, copy EVERY line except the one below this comment!
#BE SURE TO CHANGE THE FILENAMES AS DESCRIBED IN THE ORDER BELOW
# EX. predict_age_gender_race("iv1_outputs.csv", "detected_faces")
    predidct_age_gender_race("THE NAME OF THE CSV FILE FOR YOUR PREDICTIONS FROM THIS MODEL", 
                             "FOLDER TO READ FROM WHERE YOUR DETECTED FACES ARE LOCATED")